...
How that classifier grew up, the three seconds a bot gets to acknowledge, the gate that once ate a reply to its own question, and the rest of what it takes for a bot to survive real users became an essay of its own: **[What I learned creating a Slack bot](/slack-bot/)**. This post stays on Junto, and the bot lessons live there.
