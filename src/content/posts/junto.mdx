...
[^c6-1]: One boundary is better named than hidden: the broker feeds one validated funnel, and nothing subscribes to it. Plays and distillers still pull rows newer than a watermark. A queue at the edges isn't an event-driven architecture, and I'd rather say so than imply otherwise.
...
<Diagram
  src="junto-inside-every-tool.png"
  label="Fig. 19b"
/>
