...
<Diagram
  src="junto-webhook-explainer.html"
  label="Fig. 20"
  caption="A webhook is Slack knocking on a public door you put up. A websocket is a line your own app dials out and holds open. The queue, the worker, and the executor in the middle are the custom backend an off-the-shelf connector doesn't have, and Sim watches and draws without ever speaking to Slack."
  height={1700}
/>
