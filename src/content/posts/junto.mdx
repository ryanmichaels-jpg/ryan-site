...
<Diagram
  ...
  label="Fig. 7"
  caption="The engine's canvas. A workflow is a row of blocks you can build from 1,000+ triggers, integrations, and blocks without writing any code."
  width={816}
/>
...
{/* TK: [SCREENSHOT: the Junto app card in Slack, icon plus name plus the one-line description] */}
...
{/* TK: [SCREENSHOT: the Slack provenance block, built by Ryan with the run count] */}
...
{/* TK: [SCREENSHOT: the remix button as it appears in the Slack channel] */}
