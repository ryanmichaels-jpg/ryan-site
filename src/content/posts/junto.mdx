...
<Diagram
  src="junto-d4-row-shapes.png"
  label="Fig. 11"
  caption="The four stores in full, and the two shapes everything narrows into on the way to an answer. Written once, cited forever."
/>
...
<Diagram
  src="junto-d8-three-rows.png"
  label="Fig. 15"
  caption="Three of the seven cases, carried end to end. One event in, one typed row, one flattened copy, and one line the model is allowed to cite."
/>
