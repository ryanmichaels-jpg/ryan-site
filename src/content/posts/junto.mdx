...
The map was almost too neat. Slack was location, Gong was learning, Outreach and GitHub were sharing,[^c1-2] and Salesforce was the record everything else deposited into. Four relationships our projects never had.
...
So the system splits the job in two. Provenance is automatic, and gratitude is a ritual that Junto prompts for. When a rep uses your play for the first time, and again at milestones, the bot nudges them to say thanks in public. The nudge is capped, once per play per thread, three per play per week.[^c7-2] The thanks stays scarce enough to mean something.
...
The outcomes are measurable, just not yet by me. Stripe measures them on Kai, their internal knowledge platform: account executives produce twice the sales activity and close 39% more deals in the weeks they use it than the same sellers do in the weeks they don't, and it has shifted 25,000 hours a year from admin work toward revenue work. I'm citing their numbers for one reason. They're what closed loops look like when a whole company keeps them closed. My demo proves the machine runs. Their numbers are the thing the bet is actually chasing.
