...
<Diagram
  ...
  label="Fig. 20"
  caption="The demo, wearing the surface it was built for. The seeded thread is a recording and says so, with its date. The chips and the compose box run live against the real service when it is up, and the badge tells you which one you are getting."
  height={800}
/>
