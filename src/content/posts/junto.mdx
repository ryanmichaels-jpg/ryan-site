...
[^c2-1]: Worth naming, because it cuts against this chapter: what her team built is a set of customer hubs you open inside Notion, and that's a place you go, which is one of the reasons I said tools die. But they work at Notion and they sell Notion, so I'd guess that's where most of their workday already happens.
...
> @junto a former colleague and an SE met with Contoso about six months ago, before this was my account. What did they ask each other beforehand, what did the customer actually say, and what did they conclude afterward?
...
That last one is the learning loop closing on itself, and it's harder than it looks for a reason worth saying out loud. Reading a teammate's results means reading data that was pulled with his permissions and not mine. So the honest version of that play needs a door built for it rather than a gap left open. Nothing else in this chapter has that problem, because nothing else lets one person's work become another person's input.
